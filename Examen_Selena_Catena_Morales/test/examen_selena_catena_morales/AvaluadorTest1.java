...
public static Collection<Object[]> data() {
        Object[][] data = new Object[][]{
            ...
            {  new Estudiant("Ana", 2.0, 2.0, 2.0),2.0},
            {new Estudiant ("Ainoa", 1.0, 1.0, 1.0), 1.0},
            {new Estudiant ("Pepe", 0.0, 10.0, 2.0), 4.0},
            {new Estudiant ("Carlos", 0.0, 0.0, 0.0), 0.0},
            {new Estudiant ("Inma", 5.0, 5.0, 10.0), 6.666},
            {new Estudiant ("Merce", 10.0, 10.0, 10.0), 10.0},
            {new Estudiant ("Encarni", 1.0, 1.0, 1.0), 1.0},
            {new Estudiant ("Tere", 2.0, 2.0, 2.0), 2.0},
            {new Estudiant ("Andrea", 0.0, 0.0, 0.0), 0.0},
            {new Estudiant ("Tania", 1.5, 10.0, 5.0), 5.5},
            {new Estudiant ("Esther", 4.0, 4.0, 4.0), 4.0},
            {new Estudiant ("Pilar", 7.0, 7.0, 7.0), 7.0},
            {new Estudiant ("Lucia", 1.0, 9.0, 7.0), 5.666}
    ...
    public void testMitjana() throws Exception {
         Assert.assertEquals(mitjana, instance.mitjana(estudiant0), 0.001);
    }
